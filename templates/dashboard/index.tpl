      ...
      <div class="panel panel-default container-fluid" style="margin: 10px 0 10px 0; padding: 10px;">
        <div class="row">
          <div class="col-md-3 form-group">
            <label class="control-label">dashboard id：</label>
            <input type"text" id="id" name="id" value="{{ id }}">
          </div>
          <div class="col-md-3 form-group">
            <label class="control-label">dashboard 名称：</label>
          ...
          <div class="col-md-1">
            <a type="button" href="/dashboard/edit" target="_blank" class="form-control btn btn-success btn-block">新增</a>
          </div>
        </div>
        </div>
      </div>
    ...
    <table id="maingrid" class="table table-condensed table-hover table-striped">
      <thead>
        <tr>
          ...
          <th data-column-id="name" data-width="auto">dashboard 名称</th>
