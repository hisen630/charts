...
{% block footer %}
    ...
    <script src="/static/js/datasource/fakecube_edit.js"></script>
{% endblock %}
{% block content %}
<form class="form-horizontal" action="/datasource/save" method="POST">
    ...
    <div class="form-group" >
        ...
        <select name="tid_table" class="multiple col-md-10" >
        </select>
    </div>
    <div class="col-md-12 form-group" >
    ...
    <div class="col-md-11 form-group" >
        <span style="color:red;font-size:0.2em">注意：表名统一写成<strong>task_table</strong>;当需要指定task_table d的alias时不用使用as，系统会直接指定为<strong></strong>_task_table(example:select * from task_table left join some b on _task_table.id=b.id);查看字段请点击<strong>view result</strong></span>
    </div>
    <div class="col-md-11 form-group" >
