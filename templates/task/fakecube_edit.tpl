...
{% block footer %}
    ...
    <script src="/static/js/task/fakecube_edit.js"></script>
{% endblock %}
{% block content %}
<form class="form-horizontal" action="/datasource/save" method="POST">
    ...
    <div class="col-md-2 form-group">
        <button type="button" class="btn btn-info" id="view_result">view structure</button>
    </div>
...
<div class="col-md-12" id="data_show" data-conf='{%if data.profile%}{{data.profile|tojson}}{%endif%}'>
</div>
